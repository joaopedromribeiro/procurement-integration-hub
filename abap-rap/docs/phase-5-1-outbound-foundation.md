...
| The coordinator, the first real `POST` from a persisted intent, receipt handling, the `SENT` transition and lease management — **next, not started**; needs **P14** for the correlation UUID | 5.2g |
