...
- `purchase_order_number` is a human-readable number. It is not the primary key, automatically generated, or uniqueness-enforced in Phase 1. Number assignment/uniqueness will be addressed in Phase 2.
