...
| SAP BTP Integration Suite, Cloud Integration, XML mapping | Deployed iFlows and message processing evidence | **Phase 6.1 runtime-verified** — `PIH_OrderDelivery_v1` deployed in a dedicated subaccount, with Completed and Failed message-processing evidence for a valid and an invalid source contract. Mapping is Phase 6.2 and is not built |
